...
export default function HistoryPage() {
    ...
    return (
        <div className="w-screen h-screen flex flex-col pointer-events-auto overflow-hidden border border-subtle rounded-[28px] relative bg-app-bg text-white">
            {/* Header */}
            ...
            <div className="px-6 pb-4 shrink-0">
                <div className="relative group">
                    ...
                    <input 
                        ...
                        className="w-full h-12 bg-surface border border-subtle rounded-2xl pl-12 pr-4 text-[13px] font-bold focus:outline-none focus:border-orange-500/50 focus:bg-white/8 transition-all placeholder:text-white/20"
                    />
                </div>
            </div>
                                ...
                                >
                                    ...
                                    <div className="absolute right-2 bottom-2 flex gap-1 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all">
                                        <button 
                                            ...
                                            className="p-1.5 rounded-lg bg-surface-hover border border-subtle hover:bg-surface-hover text-muted hover:text-white"
                                        >
                                            <Copy size={12} />
                                        </button>
                                        <button 
                ...
                <AnimatePresence>
                    {selectedEntry && (
                        <motion.div
                            ...
                            className="absolute inset-y-0 right-0 w-[420px] bg-panel border-l border-subtle shadow-2xl z-50 flex flex-col"
                        >
                                ...
                                <div className="flex gap-2">
                                    {selectedEntry.raw_text && selectedEntry.raw_text !== selectedEntry.final_text && (
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-3 py-2 rounded-xl bg-surface-hover border border-strong text-muted hover:bg-surface-hover hover:text-white transition-all font-black text-[10px] uppercase tracking-wider"
                                            title="Copy raw text"
                                        >
                                            <Copy size={14} /> Raw
                                        </button>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {selectedEntry.raw_text && selectedEntry.raw_text !== selectedEntry.final_text && (
                                        <div className="space-y-2">
                                            ...
                                            <div className="p-5 rounded-2xl bg-white/1 border border-subtle text-[13px] leading-relaxed font-bold text-muted italic">
