...
export const CONTENT = {
    ru: {
        ...
        settings: {
            ...
            autoPauseBrowserFixBtn: 'Закройте браузеры и нажмите (Magic Fix)',
            autoPauseBrowserFixSuccess: 'Готово! Теперь откройте браузеры.',
    ...
    en: {
        ...
        settings: {
            ...
            autoPauseBrowserFixBtn: 'Close Browsers & Magic Fix',
            autoPauseBrowserFixSuccess: 'Done! Now open your browsers.',
