...
|---|---|---|---|
| `/` (root) | Tauri-приложение NYX Vox | Next.js 16 + Rust (Tauri 2) | активный, v1.2.0 |
...
|---|---|---|
| docs/CHANGELOG.md | ✅ актуально | Подробный changelog v1.2.0 |
...
| docs/README.md | ⚠️ устарело | Версия 1.0.0 вместо 1.2.0 |

## Открытые вопросы к автору проекта
- Есть ли планы на кроссплатформенность (Windows/Linux)?
- Планируется ли добавление тестов?
- Есть ли CI/CD пайплайн для автоматического тестирования?
