...
- Реализованы и протестированы ключевые фичи и исправления:
  ...
  2. **100% сохранение всех авторских слов (Verbatim)**:
     - Исправлен `is_lone_filler` в `utils.rs`: защищены русские предлоги и союзы («и», «а», «у», «о», «к», «в», «с»), которые раньше ошибочно удалялись.
     - Усилен системный промпт форматирования: строгий запрет на изменение падежей (винительный -> именительный) и сокращение/выбрасывание фраз.
