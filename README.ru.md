...
- [ ] Кастомные глобальные горячие клавиши (переназначение)
- [ ] Экспорт истории (TXT / MD / JSON) и полнотекстовый поиск
- [ ] Пользовательский словарь / технические термины
- [ ] Прогресс-бар транскрипции Whisper
- [ ] Стриминг для Deepgram (WebSocket вместо batch REST)
- [ ] Голосовые команды и управление Mac
- [ ] Error boundary + структурированное логирование (фронтенд)
- [ ] CI/CD пайплайн: clippy + test + build при каждом PR
- [ ] Мультиязычный перевод (долгосрочно)
