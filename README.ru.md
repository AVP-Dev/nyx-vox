...
- **Google Gemini 2.5 (`gemini-2.5-flash` / `pro`)**: Превосходная работа со смешанными языками и сложным контекстом.
...
- 🧠 **Поддержка множества LLM**: форматирование через DeepSeek V4, Qwen 3.7, Gemini 2.5, Groq LPU или GigaChat 2.
